...
#------------------------------------------
resource "google_cloud_tasks_queue" "task_post_dai0kou_v0_9" {
  name     = "task-post-dai0kou-blog-v-0-9"
  location = var.region
...
resource "google_cloudfunctions2_function" "function_generate_task" {
  ...
  service_config {
    ...
    environment_variables = {
      ...
      TASK_QUEUE_NAME   = google_cloud_tasks_queue.task_post_dai0kou_v0_9.name
  ...
  depends_on = [
    ...
    google_cloud_tasks_queue.task_post_dai0kou_v0_9
  ]
}
